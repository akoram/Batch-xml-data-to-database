...
import com.demoprocessor.PersonItenProcessor;
...
public class BatchConfig {
	...
	public StaxEventItemReader<Person> reader(){
		...
		//File directory = new File("D:\\persons.xml");
				
		reader.setResource(new ClassPathResource("persons.xml"));
		reader.setFragmentRootElementName("person");
		
		Map<String,String> aliasesMap =new HashMap<String,String>();
		aliasesMap.put("person", "com.demo.model.Person");
	...
	public JdbcBatchItemWriter<Person> writer(){
		...
		writer.setSql("INSERT INTO person(person_id, first_name, last_name, code, salary, fresher, email, age) 	VALUES (?, ?, ?, ?, ?, ?, ?, ?);");
